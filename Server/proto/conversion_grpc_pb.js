...
var proto_conversion_pb = require('../proto/conversion_pb.js');

function serialize_conversion_ConversionReply(arg) {
  if (!(arg instanceof proto_conversion_pb.ConversionReply)) {
...
function deserialize_conversion_ConversionReply(buffer_arg) {
  return proto_conversion_pb.ConversionReply.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_conversion_ConversionRequest(arg) {
  if (!(arg instanceof proto_conversion_pb.ConversionRequest)) {
...
function deserialize_conversion_ConversionRequest(buffer_arg) {
  return proto_conversion_pb.ConversionRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var ConverterService = exports.ConverterService = {
  fileConvert: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: proto_conversion_pb.ConversionRequest,
    responseType: proto_conversion_pb.ConversionReply,
