...
INSERT INTO "new_Review" ("completed", "filmId", "id", "invitedUserId", "issuedById", "rating", "review", "reviewDate", "userId") SELECT "completed", "filmId", "id", "invitedUserId", "issuedById", "rating", "review", "reviewDate", "userId" FROM "Review";
DROP TABLE "Review";
